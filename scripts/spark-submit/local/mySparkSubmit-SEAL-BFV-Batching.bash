...
case $ynq in
	[Yy]* ) 
		...
		run_spark_submit_command  sparkfhe_keygen  spiritlab.sparkfhe.example.batching.KeyGenExample local SEAL BFV;;
    [Nn]* ) 
...
case $ynq in
	[Yy]* ) 
		...
		run_spark_submit_command  sparkfhe_encryption_decryption  spiritlab.sparkfhe.example.batching.EncDecExample local SEAL BFV \
...
case $ynq in
	[Yy]* ) 
		run_spark_submit_command  sparkfhe_basic_OPs_examples  spiritlab.sparkfhe.example.batching.BasicOPsExample local SEAL BFV \
			"gen/keys/my_public_key.txt" \
			"gen/keys/my_secret_key.txt";;
    [Nn]* ) 
		echo "Skip to the next job.";;
...
case $ynq in
	[Yy]* ) 
		run_spark_submit_command  sparkfhe_dot_product_examples  spiritlab.sparkfhe.example.batching.DotProductExample local SEAL BFV \
			"gen/keys/my_public_key.txt" \
			"gen/keys/my_secret_key.txt";;
    [Nn]* ) 
		echo "Skip to the next job.";;
...
case $ynq in
	[Yy]* ) 
		run_spark_submit_command  sparkfhe_total_sum_examples  spiritlab.sparkfhe.example.batching.TotalSumExample local SEAL BFV \
			"gen/keys/my_public_key.txt" \
			"gen/keys/my_secret_key.txt";;
    [Nn]* ) 
		echo "Skip to the next job.";;
