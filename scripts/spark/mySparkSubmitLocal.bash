...
run_spark_submit_command  sparkfhe_encryption_decryption  spiritlab.sparkfhe.example.basic.EncDecExample local 1 "gen/keys/my_public_key.txt" "gen/keys/my_secret_key.txt"
